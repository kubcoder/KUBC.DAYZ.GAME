...
# Изменения
## 8.4 (начато)
Тотальный рефакторинг проекта! Причины можно узнать [на сайте разработчика](https://kubcoder.ru/news/dayz/game/start84)!!!

Добавлена возможность добавлять новые парсеры в имеющиеся логи. Т.е. буквально к логу ADM можно прикрутить новые парсеры для разбора
