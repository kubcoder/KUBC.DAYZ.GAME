...
{
    /// <summary>
    /// Класс игнора чего-то... 
    /// Вот честно в душе не ебу что это...
    /// </summary>
    [Serializable]
    [XmlType("ignore")]
    public class File
    {
        ...
        /// </summary>
        public const string FILENAME = "cfgignorelist.xml";
        ...
        /// </summary>
        /// <param name="FullFileName">Полное имя файла. Т.е. буквально C:\...\db\cfgignorelist.xml</param>
