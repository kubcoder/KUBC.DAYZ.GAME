...
{
    /// <summary>
    /// Класс работы с файлом mapclusterproto.xml
    /// </summary>
    [Serializable]
    [XmlType("prototype")]
    public class File
    {
        /// <summary>
        /// Определения экспорта геометрии в центральную экономику.
        /// </summary>
        [XmlElement("clusters")]
        public ExportClusters ExportClusters { get; set; } = new();
        /// <summary>
        /// Список настроенных кластеров
        /// </summary>
        [XmlElement("cluster")]
        ...
        /// </summary>
        public const string FILENAME = "mapclusterproto.xml";
