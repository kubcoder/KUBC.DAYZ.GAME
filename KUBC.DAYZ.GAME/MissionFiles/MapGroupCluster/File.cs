...
{
    /// <summary>
    /// Класс для работы с файлами mapgroupcluster.xml
    /// </summary>
    [Serializable]
    [XmlType("map")]
    public class File
    {
        ...
        /// </summary>
        [XmlElement("group")]
        public List<Group> Clusters { get; set; } = new();
        /// <summary>
        /// Следующий файл
        /// </summary>
        [XmlElement("include")]
        public Include? NextFile { get; set; }

        #region Загрузка и сохранение файла
        /// <summary>
        /// Имя файла в серверных файлах
        /// </summary>
        public const string FILENAMEPATERN = "mapgroupcluster";
